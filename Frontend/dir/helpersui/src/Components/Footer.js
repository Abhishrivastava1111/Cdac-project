        ...
        <div className="big-footer">
            <div className="footer-content">
                ...
                <div className="image-and-text">
                        <img
                            src="https://firebasestorage.googleapis.com/v0/b/helpers--planet.appspot.com/o/pexels-sanket-mishra-16034402.jpg?alt=media&token=d046ee3e-d0af-428f-a697-afbd140e713c"
                            alt="StaticImage"
                    ...
                    <div className="contact-details">
                        <h4>Contact Us</h4>
                        <p>
                            Address: sunbeam karad, satara, india<br />
                            Mobile: 1234567891<br />
